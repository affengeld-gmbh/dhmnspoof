...
gcc -DHAVE_CONFIG_H -I. -I../includes  -DCLIENT_PATH='"PATH=/usr/sbin:/sbin:/bin:/usr/sbin:/usr/bin"' -DLOCALSTATEDIR='"/var"'   -g -O2  -Wall -Werror -fno-strict-aliasing -I../includes -I/root/iscdhcp/dhcp-4.4.1/bind/include -MT dhclient.o -MD -MP -MF .deps/dhclient.Tpo -c -o dhclient.o dhclient.c

...
SUBDIRS="acl additional addzone allow_query autosign builtin
	 cacheclean case catz chain checkconf  checknames checkzone
	 cookie  database digdelv dlv dlvauto dlz dlzexternal
	 dns64 dnssec  dscp dsdigest dyndb ecdsa
	 ...
	 pending  pipelined reclimit redirect resolver

...
A = a
ACLOCAL = ${SHELL} /root/iscdhcp/dhcp-4.4.1/missing aclocal-1.15
AMTAR = $${TAR-tar}
...
ATF_CFLAGS = 
ATF_LDFLAGS = 
AUTOCONF = ${SHELL} /root/iscdhcp/dhcp-4.4.1/missing autoconf
AUTOHEADER = ${SHELL} /root/iscdhcp/dhcp-4.4.1/missing autoheader
AUTOMAKE = ${SHELL} /root/iscdhcp/dhcp-4.4.1/missing automake-1.15
AWK = gawk
BINDCONFIG =  --with-randomdev=/dev/random
BINDDIR = /root/iscdhcp/dhcp-4.4.1/bind
BINDIOMUX = --disable-kqueue --disable-epoll --disable-devpoll
BINDLIBDNSDIR = /root/iscdhcp/dhcp-4.4.1/bind/bind-9.11.2-P1/lib/dns
BINDLIBIRSDIR = /root/iscdhcp/dhcp-4.4.1/bind/bind-9.11.2-P1/lib/irs
BINDLIBISCCFGDIR = /root/iscdhcp/dhcp-4.4.1/bind/bind-9.11.2-P1/lib/isccfg
BINDLIBISCDIR = /root/iscdhcp/dhcp-4.4.1/bind/bind-9.11.2-P1/lib/isc
BINDLT = 
BINDSRCDIR = /root/iscdhcp/dhcp-4.4.1/bind/bind-9.11.2-P1
BINDSUBDIR = ${top_srcdir}/bind
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2  -Wall -Werror -fno-strict-aliasing -I$(top_srcdir)/includes -I/root/iscdhcp/dhcp-4.4.1/bind/include
CPP = gcc -E
CPPFLAGS = 
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /root/iscdhcp/dhcp-4.4.1/missing makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = dhcp
...
UNITTESTS = 
VERSION = 4.4.1
abs_builddir = /root/iscdhcp/dhcp-4.4.1
abs_srcdir = /root/iscdhcp/dhcp-4.4.1
abs_top_builddir = /root/iscdhcp/dhcp-4.4.1
abs_top_srcdir = /root/iscdhcp/dhcp-4.4.1
ac_ct_CC = gcc
ac_prefix_program = 
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /root/iscdhcp/dhcp-4.4.1/install-sh
